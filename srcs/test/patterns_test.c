...
void	test_pattern(t_tup p, t_color exp, char *tn)
{
	t_color	result;
	t_obj	*sp;
	t_tup	views[2];
...
void	pattern_test_battery(void)
{
	...
	test_pattern(point(0, 0, 0), white(), "Stripe at (0, 0, 0)");
	test_pattern(point(0.9, 0, 0), white(), "Stripe at (0.9, 0, 0)");
	test_pattern(point(1, 0, 0), black(), "Stripe at (1, 0, 0)");
	test_pattern(point(-0.1, 0, 0), black(), "Stripe at (-0.1, 0, 0)");
	test_pattern(point(-1, 0, 0), black(), "Stripe at (-1, 0, 0)");
	test_pattern(point(-1.1, 0, 0), white(), "Stripe at (-1.1, 0, 0)");
}
